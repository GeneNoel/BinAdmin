...
const CollectorForm = ({ toggleModal }) => {
  return (
    <Fragment>
              ...
              <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <div className="relative">
                  <select
                    ...
                    id="grid-state"
                  >
                    <option className="font-inter">New Mexico</option>
                    <option className="font-inter">Missouri</option>
                    <option className="font-inter">Texas</option>
                  </select>
...
export default hot(module)(CollectorForm);
